...
export default function Reports() {
  ...
  const [filters, setFilters] = useState({
    ...
    date_mode: 'delivery' // Added date_mode
  });
  ...
  // ... [exportPDF and exportCSV functions remain unchanged] ...
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-card border rounded-lg p-4 mb-6">
        ...
        {/* Updated grid to 7 columns to fit the new Select */}
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
          ...
          {/* ... [Client, Sub, Cycle selects remain the same] ... */}
