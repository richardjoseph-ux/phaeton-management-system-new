...
const COMPANY = {
  ...
  address: 'Block 3 Lot 1, Pacita 2-B, Cyan St., Brgy. San Lazara, City of San Pedro, Laguna, Philippines',
  phone: '0931-974-6058',
...
export default function BillingStatementPDFDelivery() {
  const { user } = useAuth();
  ...
  const handleExcelExport = async () => {
    ...
    setGenerating(true);
    try {
      exportStatementExcel({ title: 'Top Sheet (Delivery)', cycle: selectedCycle, client: selectedClient, trips, soaDate, periodCovered, serviceLabel: 'Warehouse', includeDr: true });
    } finally {
      setGenerating(false);
    }
  };
